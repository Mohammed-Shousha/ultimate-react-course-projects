...
function App() {
  ...
  return (
    <section>
      ...
      /*Setter functions of the useState always have stable identity so they will not change on renders (memoized) that why it's okay to omit them from the dependency array of the hooks*/ />
      <Footer />
    </section>
  );
}
